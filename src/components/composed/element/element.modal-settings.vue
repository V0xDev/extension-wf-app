...
<template>
  <CommonModalContainer>
    <div
      @click.stop
      class="w-[300px] h-[400px] flex flex-col bg-black rounded-8 border-2 border-border-opacity"
    >
      <div class="flex sticky top-0 justify-between items-center p-18 shadow-b">
        <p class="text-18 leading-17">Настройки</p>
        <button @click="close">
          <CommonIconWrapper>
            <IconClose />
          </CommonIconWrapper>
      ...
      <div class="settings p-18 flex-1 flex flex-col overflow-y-auto">
        <div class="settings flex flex-col gap-10">
          <h2 class="font-medium text-16 leading-16 text-dark">Системные</h2>
          <div class="flex items-center gap-5">
            <p class="font-medium text-16 mt-6 leading-16 text-dark opacity-50">Тема:</p>
